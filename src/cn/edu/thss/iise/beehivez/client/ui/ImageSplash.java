...
public class ImageSplash extends JWindow implements ISplash {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7463897893560851456L;
	...
	public ImageSplash() throws HeadlessException {
		super();
	...
	public void close() {
		...
		if (ClientFrame.getInstance() != null) {
			closeThread.start();
		}
	}

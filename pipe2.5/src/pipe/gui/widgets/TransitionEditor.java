...
public class TransitionEditor extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		timedRadioButton.setBorder(javax.swing.BorderFactory.createEmptyBorder(
				0, 0, 0, 0));
		...
		immediateRadioButton.setBorder(javax.swing.BorderFactory
				.createEmptyBorder(0, 0, 0, 0));
		...
		singleServerRadioButton.setBorder(javax.swing.BorderFactory
				.createEmptyBorder(0, 0, 0, 0));
		...
		infiniteServerRadioButton.setBorder(javax.swing.BorderFactory
				.createEmptyBorder(0, 0, 0, 0));
		...
		try {
			if ((rateComboBox.getSelectedIndex() > 0)
					&& (((RateParameter) rateComboBox.getSelectedItem())
							.getValue() != Double.parseDouble(rateTextField
							.getText()))) {
			...
			if (!nfe.getMessage().equalsIgnoreCase("empty String")) {
				System.out
						.println("NumberFormatException (not Empty String): \n"
								+ nfe.getMessage());
			}
		} catch (Exception e) {
	...
	private void rateComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_rateComboBoxActionPerformed
		...
		if (index > 0) {
			rateTextField.setText(pnmlData.getRateParameters()[index - 1]
					.getValue().toString());
		}
	...
	private void immediateRadioButtonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_immediateRadioButtonActionPerformed
	...
	private void okButtonHandler(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_okButtonHandler
		...
		if (rateComboBox.getSelectedIndex() > 0) {
			...
			RateParameter parameter = (RateParameter) rateComboBox
					.getSelectedItem();
